...
-(IBAction)play:(id)sender{
    ...
    NSURL *movieURL = [NSURL URLWithString:@"http://webdemo.com.es/pnkv/nutricion.mp4"];  // sample url
    ...
    NSURL *url = [NSURL URLWithString:@"http://webdemo.com.es/pnkv/nutricion.mp4"];
